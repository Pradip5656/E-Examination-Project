				...
				<div class="carousel-item active">
					...
					<div class="container-fluid">
						<div class="carousel-caption text-right" >
							...
							<b  class="info">A Simple and Easy to use Online Examination</b><br>
							<b> tool for Colleges and Universities and competitive Exam .</b>
							<p>
				...
				<div class="carousel-item">
					...
					<div class="container-fluid">
						<div class="carousel-caption text-right">
							...
							<b  class="info" >A Clean and an Elegant User Interface with Minimal
								Complexities.</b>
							<p>
...
p    {color: black;}
    ...
    <div class="row welcome text-center">
        ...
        <div class="col-12">
            <p class="lead">
                An E-Examination Tool that allows for the swift, efficient and smooth conduction of college and university exams.
            </p>
        </div>
    </div>
    </div>
